...
- **0.22.0** (2026-08-02) — v6 protocol: tiered references (0xE0–0xE3) for compact object graphs; range/slice now constructed directly
...
- **0.3.0** (2026-06-18) - `Extension` introduced
- **0.2.0** (2026-06-14) - Recursive descent eliminated, explicit stack for unbounded nesting
