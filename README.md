...
For example, to serialize a dictionary containing a `datetime` object:
...
You can also combine your extension with built-in ones or custom ones using `|=`. For example, to combine your `datetime` extension with the built-in one:
