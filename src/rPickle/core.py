...
def load(f: _BinaryIO, extensions: Extension | None = None) -> _Any:
    ...
    match version:
        case 1:
            from .pcls.core_p1 import load as load_v1
            return load_v1(f, extensions)
        case x if x == _version: return _load(f, extensions)
...
def dump(obj: _Any, f: _BinaryIO, extensions: Extension | None = None, protocol: int = _version):
    ...
    match protocol:
        case 1:
            from .pcls.core_p1 import dump as dump_v1
            return dump_v1(obj, f, extensions)
        case x if x == _version: return _dump(obj, f, extensions)
